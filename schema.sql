...
CREATE TYPE "public"."booking_session_status" AS ENUM (
    'initiated',
    'details_completed',
    'payment_pending',
    'confirmed',
...
ALTER TYPE "public"."booking_session_status" OWNER TO "postgres";


CREATE TYPE "public"."paid_type" AS ENUM (
    'PLATFORM',
    'CASH'
);


ALTER TYPE "public"."paid_type" OWNER TO "postgres";
...
CREATE TYPE "public"."web_editor" AS ENUM (
    'SECTIONS',
    'CUSTOM'
);


ALTER TYPE "public"."web_editor" OWNER TO "postgres";


COMMENT ON TYPE "public"."web_editor" IS 'Type of web editor';



CREATE OR REPLACE FUNCTION "public"."confirm_booking_session"("p_booking_session_id" "text", "p_business" "uuid", "p_client_metadata" "jsonb", "p_service_id" "uuid", "p_start" timestamp with time zone, "p_end" timestamp with time zone, "p_status" "text", "p_service_data" "jsonb", "p_require_deposit" boolean, "p_paid_deposit" boolean, "p_deposit_charge_id" "text", "p_reschedules" integer, "p_deposit_price" numeric, "p_selected_addons" "jsonb", "p_amount_due" numeric, "p_subtraction" boolean) RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  session_record booking_sessions%ROWTYPE;
BEGIN

  -- 1. Lock session (ONLY for safety + idempotency)
  ...
  -- 2. Idempotency guard
  IF session_record.status = 'confirmed' THEN
    RETURN;
  END IF;

  -- 3. Slot availability check (USE PARAMS ONLY)
  IF EXISTS (
    SELECT 1
    FROM appointments a
    WHERE a.business = p_business
      AND tsrange(a.start, a.end, '[)') &&
          tsrange(p_start, p_end, '[)')
  ) THEN
    RAISE EXCEPTION 'Slot already booked';
  END IF;

  -- 4. Create appointment (PARAMS ONLY — as requested)
...
ALTER FUNCTION "public"."confirm_booking_session"("p_booking_session_id" "text", "p_business" "uuid", "p_client_metadata" "jsonb", "p_service_id" "uuid", "p_start" timestamp with time zone, "p_end" timestamp with time zone, "p_status" "text", "p_service_data" "jsonb", "p_require_deposit" boolean, "p_paid_deposit" boolean, "p_deposit_charge_id" "text", "p_reschedules" integer, "p_deposit_price" numeric, "p_selected_addons" "jsonb", "p_amount_due" numeric, "p_subtraction" boolean) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."confirm_booking_session"("p_booking_session_id" "text", "p_user_id" "uuid", "p_business" "uuid", "p_client_metadata" "jsonb", "p_service_id" "uuid", "p_start" timestamp with time zone, "p_end" timestamp with time zone, "p_status" "text", "p_service_data" "jsonb", "p_require_deposit" boolean, "p_paid_deposit" boolean, "p_deposit_charge_id" "text", "p_reschedules" integer, "p_deposit_price" numeric, "p_selected_addons" "jsonb", "p_amount_due" numeric, "p_subtraction" numeric) RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$DECLARE
  session_record booking_sessions%ROWTYPE;
BEGIN
...
ALTER FUNCTION "public"."confirm_booking_session"("p_booking_session_id" "text", "p_user_id" "uuid", "p_business" "uuid", "p_client_metadata" "jsonb", "p_service_id" "uuid", "p_start" timestamp with time zone, "p_end" timestamp with time zone, "p_status" "text", "p_service_data" "jsonb", "p_require_deposit" boolean, "p_paid_deposit" boolean, "p_deposit_charge_id" "text", "p_reschedules" integer, "p_deposit_price" numeric, "p_selected_addons" "jsonb", "p_amount_due" numeric, "p_subtraction" numeric) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."dashboard_bookings_this_month"("business" "uuid") RETURNS bigint
    LANGUAGE "sql"
    AS $$
  select count(*)
  from appointments
...
ALTER FUNCTION "public"."dashboard_bookings_this_month"("business" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."dashboard_new_clients_this_month"("business" "uuid") RETURNS bigint
    LANGUAGE "sql"
    AS $$
  select count(distinct client_metadata->>'email')
  from appointments
  where business = business
  and date_trunc('month', created_at) = date_trunc('month', now());
$$;
...
ALTER FUNCTION "public"."dashboard_new_clients_this_month"("business" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."dashboard_returning_rate"("business" "uuid") RETURNS double precision
    LANGUAGE "sql"
    AS $$
  select
    count(*) filter (where booking_count > 1)::float
    / nullif(count(*), 0)
  from (
    select client_metadata->>'email' as email,
           count(*) as booking_count
    from appointments
    where business = business
    group by client_metadata->>'email'
  ) t;
$$;


ALTER FUNCTION "public"."dashboard_returning_rate"("business" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."dashboard_revenue_this_month"("business" "uuid") RETURNS bigint
    LANGUAGE "sql"
    AS $$
...
ALTER FUNCTION "public"."dashboard_revenue_this_month"("business" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_dashboard_growth"("p_stylist_id" "uuid") RETURNS TABLE("revenue_this_month" bigint, "revenue_last_month" bigint, "revenue_growth" numeric, "clients_this_month" bigint, "clients_last_month" bigint, "clients_growth" numeric)
    LANGUAGE "sql"
    AS $$
  with revenue_totals as (
    select
      sum(
        case
          when date_trunc('month', start) = date_trunc('month', current_date)
          then paid_amount
        end
      ...
      sum(
        case
          when date_trunc('month', start) = date_trunc('month', current_date - interval '1 month')
          then paid_amount
        end
  ...
  client_totals as (
    select
      ...
      ) as clients_last_month

    from business_clients
    where business = p_stylist_id
  )

  select
    coalesce(r.revenue_this_month, 0),
    coalesce(r.revenue_last_month, 0),

    case
      when coalesce(r.revenue_last_month, 0) = 0 then null
      else round(
        (
          (coalesce(r.revenue_this_month, 0) - r.revenue_last_month)::numeric
    ...
    coalesce(c.clients_this_month, 0),
    coalesce(c.clients_last_month, 0),

    case
      when coalesce(c.clients_last_month, 0) = 0 then null
      else round(
        (
          (coalesce(c.clients_this_month, 0) - c.clients_last_month)::numeric
          / c.clients_last_month
        ) * 100,
        2
      )
    end
  ...
  cross join client_totals c;
$$;


ALTER FUNCTION "public"."get_dashboard_growth"("p_stylist_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."search_stylists_nearby"("user_lat" double precision, "user_lon" double precision, "radius_km" double precision) RETURNS TABLE("business_id" "uuid", "business_name" "text", "email" "text", "latitude" double precision, "longitude" double precision, "location" "public"."geography", "booking_policies" "text", "is_onboarded" boolean, "completed_stripe_onboarding" boolean, "url_name" "text", "default_availability" "text", "account_settings" "jsonb", "has_marketplace_profile" boolean, "distance_meters" double precision)
...
begin
  ...
  select
    ...
    b.booking_policies,
    b.is_onboarded,
    b.completed_stripe_onboarding,
    b.url_name,
    b.default_availability,
    b.account_settings,
    b.has_marketplace_profile,
    ST_Distance(
      b.location,
...
ALTER FUNCTION "public"."search_stylists_nearby"("user_lat" double precision, "user_lon" double precision, "radius_km" double precision) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_location"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_location"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."appointments" (
    ...
    "business" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    "policy_id" "text",
    "paid_deposit" boolean DEFAULT false NOT NULL,
    "reschedules" bigint DEFAULT '0'::bigint NOT NULL,
    "deposit_price" bigint,
    "cancellation_reason" "text"[],
    "selected_addons" "jsonb"[] DEFAULT '{}'::"jsonb"[] NOT NULL,
    "amount_due" bigint DEFAULT '0'::bigint NOT NULL,
    "service_paid" boolean DEFAULT false,
    "service_paid_type" "public"."paid_type",
    "service_charge_id" "text" DEFAULT ''::"text",
    "reminder_ids" "jsonb" DEFAULT '{"client": "", "business": "", "paymentCheck": ""}'::"jsonb",
    "payment_link_id" "text" DEFAULT ''::"text" NOT NULL,
    "deposit_tax_transaction" "text" DEFAULT 'NULL'::"text",
    "eoa_tax_transaction" "text" DEFAULT 'NULL'::"text",
    "paid_amount" bigint DEFAULT '0'::bigint NOT NULL,
    "substraction" boolean DEFAULT true NOT NULL,
    "time_range" "tstzrange" GENERATED ALWAYS AS ("tstzrange"("start", "end", '[)'::"text")) STORED
);
...
COMMENT ON TABLE "public"."appointments" IS 'Generally accessible appointments';



COMMENT ON COLUMN "public"."appointments"."business" IS 'business id';



COMMENT ON COLUMN "public"."appointments"."client" IS 'client id';



COMMENT ON COLUMN "public"."appointments"."client_metadata" IS 'data for clients that don''t have an AfroAllure account';



COMMENT ON COLUMN "public"."appointments"."status" IS 'current appointment status';



COMMENT ON COLUMN "public"."appointments"."service_data" IS 'Data for selected service';



COMMENT ON COLUMN "public"."appointments"."deposit_charge_id" IS 'Stripe deposit charge id';



COMMENT ON COLUMN "public"."appointments"."policy_id" IS 'Identifies the policy id';



COMMENT ON COLUMN "public"."appointments"."reschedules" IS 'count the number of time the client has rescheduled. If it is equal to the limit then the client can no longer reschedule.';



COMMENT ON COLUMN "public"."appointments"."deposit_price" IS 'price of deposit';



COMMENT ON COLUMN "public"."appointments"."cancellation_reason" IS 'reason for cancelling appointment';



COMMENT ON COLUMN "public"."appointments"."selected_addons" IS 'addons selected with service';



COMMENT ON COLUMN "public"."appointments"."service_charge_id" IS 'Stripe paymentIntent ID';



COMMENT ON COLUMN "public"."appointments"."deposit_tax_transaction" IS 'Tracks tax transaction for deposits';



COMMENT ON COLUMN "public"."appointments"."eoa_tax_transaction" IS 'Track tax transaction for end-of-appointment payments';



COMMENT ON COLUMN "public"."appointments"."substraction" IS 'does the deposit subtract from the amount due';
...
COMMENT ON TABLE "public"."availabilities" IS 'Businesses multiple availabilities';



CREATE TABLE IF NOT EXISTS "public"."banned_clients" (
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "business_id" "uuid" DEFAULT "gen_random_uuid"(),
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
COMMENT ON TABLE "public"."banned_clients" IS 'a table for clients that are banned from booking';
...
CREATE TABLE IF NOT EXISTS "public"."booking_sessions" (
    ...
    "selected_datetime" timestamp with time zone,
    "clientInfo" "jsonb",
    "payment_intent_id" "text",
    "amount" bigint,
    "currency" "text" DEFAULT '''usd'''::"text",
    "status" "public"."booking_session_status" DEFAULT 'initiated'::"public"."booking_session_status" NOT NULL,
...
COMMENT ON TABLE "public"."booking_sessions" IS 'Stores booking data for the user as they book an appointment with a business';
...
ALTER TABLE "public"."business_clients" OWNER TO "postgres";


COMMENT ON TABLE "public"."business_clients" IS 'Businesses to clients relationship';



ALTER TABLE "public"."business_clients" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."business_clients_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."business_policies" (
    ...
    "no_show" "jsonb" NOT NULL,
    "reschedule_limit" bigint DEFAULT '2'::bigint,
    "reschedule_day_limit" bigint DEFAULT '2'::bigint,
    "cancel_day_limit" bigint DEFAULT '3'::bigint,
    "important_info" "text" DEFAULT ''::"text",
    "read_before_booking" "text" DEFAULT ''::"text",
    "book_ahead_value" "text" DEFAULT '1 month'::"text" NOT NULL
);


ALTER TABLE "public"."business_policies" OWNER TO "postgres";


COMMENT ON TABLE "public"."business_policies" IS 'Table to keep up with a business''s booking policies';
...
CREATE TABLE IF NOT EXISTS "public"."business_users" (
    ...
    "email" "text" NOT NULL,
    "stripe_acc_id" "text",
    "booking_policies" "text" DEFAULT ''::"text" NOT NULL,
    "business_id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT ("now"() AT TIME ZONE 'utc'::"text") NOT NULL,
    "is_onboarded" boolean DEFAULT false NOT NULL,
    "completed_stripe_onboarding" boolean DEFAULT false NOT NULL,
    "url_name" "text" DEFAULT ''::"text" NOT NULL,
    "current_onboarding_link" "text",
    "default_availability" "text" DEFAULT ''::"text" NOT NULL,
    "account_settings" "jsonb",
    "has_marketplace_profile" boolean DEFAULT false,
    "latitude" double precision,
    "longitude" double precision,
    "location" "public"."geography"(Point,4326),
    "published_site" boolean DEFAULT false NOT NULL,
    "stripe_customer_id" "text" DEFAULT ''::"text",
    "plan_type" "public"."plan_type" DEFAULT 'STARTER'::"public"."plan_type" NOT NULL,
    "had_trial" boolean DEFAULT false NOT NULL,
    "payment_method_config_id" "text" DEFAULT '""'::"text" NOT NULL
);
...
COMMENT ON TABLE "public"."business_users" IS 'Business users and their data';



COMMENT ON COLUMN "public"."business_users"."is_onboarded" IS 'did the user complete the onboarding process';



COMMENT ON COLUMN "public"."business_users"."url_name" IS 'url for business name';



COMMENT ON COLUMN "public"."business_users"."current_onboarding_link" IS 'current stripe onboarding link if onboarding is incomplete';



COMMENT ON COLUMN "public"."business_users"."default_availability" IS 'the uuid of the selected default availability';



COMMENT ON COLUMN "public"."business_users"."account_settings" IS 'account settings of business';



COMMENT ON COLUMN "public"."business_users"."has_marketplace_profile" IS 'if the user has a profile on the marketplace';



COMMENT ON COLUMN "public"."business_users"."published_site" IS 'is user site published';



COMMENT ON COLUMN "public"."business_users"."stripe_customer_id" IS 'Customer id for stripe';



COMMENT ON COLUMN "public"."business_users"."plan_type" IS 'User''s Plan Type';



COMMENT ON COLUMN "public"."business_users"."had_trial" IS 'if user has had access to the free trial before';
...
COMMENT ON TABLE "public"."client_users" IS 'Client users and their data';



COMMENT ON COLUMN "public"."client_users"."email" IS 'email';



COMMENT ON COLUMN "public"."client_users"."phone_number" IS 'phone number';



COMMENT ON COLUMN "public"."client_users"."first_name" IS 'First Name of client';



COMMENT ON COLUMN "public"."client_users"."last_name" IS 'Last Name of client';



CREATE TABLE IF NOT EXISTS "public"."image_section" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"(),
    "editor_id" "uuid" DEFAULT "gen_random_uuid"(),
    "fileBody" "jsonb",
    "url" "text",
...
ALTER TABLE "public"."image_section" OWNER TO "postgres";
...
ALTER TABLE "public"."marketplace_profile" OWNER TO "postgres";


COMMENT ON TABLE "public"."marketplace_profile" IS 'Business profiles for AfroAllure Marketplace';
...
CREATE TABLE IF NOT EXISTS "public"."services" (
    ...
    "categories" "text"[],
    "imagePath" "text",
    "availability" "uuid" DEFAULT "gen_random_uuid"() NOT NULL
);
...
COMMENT ON TABLE "public"."services" IS 'Various business services';



COMMENT ON COLUMN "public"."services"."imagePath" IS 'image path in supabase storage';
...
COMMENT ON TABLE "public"."user_feedback" IS 'Table for user feedback';
...
ALTER TABLE "public"."web_editors" OWNER TO "postgres";


COMMENT ON COLUMN "public"."web_editors"."type" IS 'Type of web editor';



COMMENT ON COLUMN "public"."web_editors"."image_objects" IS 'Image Objects';



COMMENT ON COLUMN "public"."web_editors"."theme_data" IS 'theme data for booking process UI';



ALTER TABLE ONLY "public"."appointments"
    ADD CONSTRAINT "appointments_id_key" UNIQUE ("id");
...
ALTER TABLE ONLY "public"."business_clients"
    ADD CONSTRAINT "business_clients_business_key" UNIQUE ("business");



ALTER TABLE ONLY "public"."business_clients"
    ADD CONSTRAINT "business_clients_client_key" UNIQUE ("client");
...
ALTER TABLE ONLY "public"."business_users"
    ADD CONSTRAINT "business_users_business_name_key" UNIQUE ("business_name");



ALTER TABLE ONLY "public"."business_users"
    ADD CONSTRAINT "business_users_email_key" UNIQUE ("email");



ALTER TABLE ONLY "public"."business_users"
    ADD CONSTRAINT "business_users_id_key" UNIQUE ("business_id");



ALTER TABLE ONLY "public"."business_users"
    ADD CONSTRAINT "business_users_pkey" PRIMARY KEY ("business_id");



ALTER TABLE ONLY "public"."business_users"
    ADD CONSTRAINT "business_users_stripe_acc_id_key" UNIQUE ("stripe_acc_id");
...
ALTER TABLE ONLY "public"."client_users"
    ADD CONSTRAINT "client_users_id_key" UNIQUE ("client_id");



ALTER TABLE ONLY "public"."client_users"
    ADD CONSTRAINT "client_users_phone_number_key" UNIQUE ("phone_number");



ALTER TABLE ONLY "public"."client_users"
    ADD CONSTRAINT "client_users_pkey" PRIMARY KEY ("client_id");



ALTER TABLE ONLY "public"."image_section"
    ADD CONSTRAINT "image_section_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."marketplace_profile"
    ADD CONSTRAINT "marketplace_profile_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."appointments"
    ADD CONSTRAINT "no_overlapping_bookings" EXCLUDE USING "gist" ("business" WITH =, "time_range" WITH &&);
...
ALTER TABLE ONLY "public"."user_feedback"
    ADD CONSTRAINT "user_feedback_id_key" UNIQUE ("id");
...
ALTER TABLE ONLY "public"."web_editors"
    ADD CONSTRAINT "web_editors_pkey" PRIMARY KEY ("id");



CREATE INDEX "idx_appt_business_created_at" ON "public"."appointments" USING "btree" ("business", "created_at");



CREATE INDEX "idx_appt_business_email" ON "public"."appointments" USING "btree" ("business", (("client_metadata" ->> 'email'::"text")));



CREATE INDEX "idx_appt_business_paid_amount" ON "public"."appointments" USING "btree" ("business", "paid_amount");



CREATE INDEX "idx_appt_business_service" ON "public"."appointments" USING "btree" ("business", (("service_data" ->> 'id'::"text")));



CREATE INDEX "idx_appt_business_start_time" ON "public"."appointments" USING "btree" ("business", "start");



CREATE INDEX "idx_appt_business_status" ON "public"."appointments" USING "btree" ("business", "status");
...
CREATE OR REPLACE TRIGGER "handle_updated_at" BEFORE UPDATE ON "public"."availabilities" FOR EACH ROW EXECUTE FUNCTION "public"."moddatetime"('updated_at');



CREATE OR REPLACE TRIGGER "handle_updated_at" BEFORE UPDATE ON "public"."business_clients" FOR EACH ROW EXECUTE FUNCTION "public"."moddatetime"('updated_at');



CREATE OR REPLACE TRIGGER "handle_updated_at" BEFORE UPDATE ON "public"."business_policies" FOR EACH ROW EXECUTE FUNCTION "public"."moddatetime"('updated_at');



CREATE OR REPLACE TRIGGER "handle_updated_at" BEFORE UPDATE ON "public"."business_users" FOR EACH ROW EXECUTE FUNCTION "public"."moddatetime"('updated_at');



CREATE OR REPLACE TRIGGER "handle_updated_at" BEFORE UPDATE ON "public"."client_users" FOR EACH ROW EXECUTE FUNCTION "public"."moddatetime"('updated_at');
...
CREATE OR REPLACE TRIGGER "handle_updated_at" BEFORE UPDATE ON "public"."service_addons" FOR EACH ROW EXECUTE FUNCTION "public"."moddatetime"('updated_at');



CREATE OR REPLACE TRIGGER "handle_updated_at" BEFORE UPDATE ON "public"."services" FOR EACH ROW EXECUTE FUNCTION "public"."moddatetime"('updated_at');



CREATE OR REPLACE TRIGGER "handle_updated_at" BEFORE UPDATE ON "public"."web_editors" FOR EACH ROW EXECUTE FUNCTION "public"."moddatetime"('updated_at');



CREATE OR REPLACE TRIGGER "set_location" BEFORE INSERT OR UPDATE OF "latitude", "longitude" ON "public"."business_users" FOR EACH ROW EXECUTE FUNCTION "public"."update_location"();



ALTER TABLE ONLY "public"."appointments"
    ADD CONSTRAINT "appointments_business_fkey" FOREIGN KEY ("business") REFERENCES "public"."business_users"("business_id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."availabilities"
    ADD CONSTRAINT "availabilities_business_id_fkey" FOREIGN KEY ("business_id") REFERENCES "public"."business_users"("business_id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."banned_clients"
    ADD CONSTRAINT "banned_clients_business_id_fkey" FOREIGN KEY ("business_id") REFERENCES "public"."business_users"("business_id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."banned_clients"
    ADD CONSTRAINT "banned_clients_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "public"."client_users"("client_id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."booking_sessions"
    ADD CONSTRAINT "booking_sessions_business_id_fkey" FOREIGN KEY ("business_id") REFERENCES "public"."business_users"("business_id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."booking_sessions"
    ADD CONSTRAINT "booking_sessions_service_id_fkey" FOREIGN KEY ("service_id") REFERENCES "public"."services"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."business_clients"
    ADD CONSTRAINT "business_clients_business_fkey" FOREIGN KEY ("business") REFERENCES "public"."business_users"("business_id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."business_clients"
    ADD CONSTRAINT "business_clients_client_fkey" FOREIGN KEY ("client") REFERENCES "public"."client_users"("client_id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."business_policies"
    ADD CONSTRAINT "business_policies_business_fkey" FOREIGN KEY ("business") REFERENCES "public"."business_users"("business_id") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."image_section"
    ADD CONSTRAINT "image_section_editor_id_fkey" FOREIGN KEY ("editor_id") REFERENCES "public"."web_editors"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."marketplace_profile"
    ADD CONSTRAINT "marketplace_profile_business_id_fkey" FOREIGN KEY ("business_id") REFERENCES "public"."business_users"("business_id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."notifications"
    ADD CONSTRAINT "notifications_appointment_id_fkey" FOREIGN KEY ("appointment_id") REFERENCES "public"."appointments"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."notifications"
    ADD CONSTRAINT "notifications_business_id_fkey" FOREIGN KEY ("business_id") REFERENCES "public"."business_users"("business_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."reviews"
    ADD CONSTRAINT "reviews_business_id_fkey" FOREIGN KEY ("business_id") REFERENCES "public"."business_users"("business_id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."service_addons"
    ADD CONSTRAINT "service_addons_business_id_fkey" FOREIGN KEY ("business_id") REFERENCES "public"."business_users"("business_id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."services"
    ADD CONSTRAINT "services_availability_fkey" FOREIGN KEY ("availability") REFERENCES "public"."availabilities"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."services"
    ADD CONSTRAINT "services_business_fkey" FOREIGN KEY ("business") REFERENCES "public"."business_users"("business_id") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."user_feedback"
    ADD CONSTRAINT "user_feedback_business_id_fkey" FOREIGN KEY ("business_id") REFERENCES "public"."business_users"("business_id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."web_editors"
    ADD CONSTRAINT "web_editors_business_id_fkey" FOREIGN KEY ("business_id") REFERENCES "public"."business_users"("business_id") ON UPDATE CASCADE ON DELETE CASCADE;



CREATE POLICY "Enable insert for authenticated users only" ON "public"."appointments" FOR INSERT WITH CHECK (true);
...
CREATE POLICY "Enable read access for all users" ON "public"."business_users" FOR SELECT USING (true);



CREATE POLICY "Public can update appointments" ON "public"."appointments" FOR UPDATE USING (true) WITH CHECK (true);
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."business_users";
...
GRANT ALL ON FUNCTION "public"."confirm_booking_session"("p_booking_session_id" "text", "p_business" "uuid", "p_client_metadata" "jsonb", "p_service_id" "uuid", "p_start" timestamp with time zone, "p_end" timestamp with time zone, "p_status" "text", "p_service_data" "jsonb", "p_require_deposit" boolean, "p_paid_deposit" boolean, "p_deposit_charge_id" "text", "p_reschedules" integer, "p_deposit_price" numeric, "p_selected_addons" "jsonb", "p_amount_due" numeric, "p_subtraction" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."confirm_booking_session"("p_booking_session_id" "text", "p_business" "uuid", "p_client_metadata" "jsonb", "p_service_id" "uuid", "p_start" timestamp with time zone, "p_end" timestamp with time zone, "p_status" "text", "p_service_data" "jsonb", "p_require_deposit" boolean, "p_paid_deposit" boolean, "p_deposit_charge_id" "text", "p_reschedules" integer, "p_deposit_price" numeric, "p_selected_addons" "jsonb", "p_amount_due" numeric, "p_subtraction" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."confirm_booking_session"("p_booking_session_id" "text", "p_business" "uuid", "p_client_metadata" "jsonb", "p_service_id" "uuid", "p_start" timestamp with time zone, "p_end" timestamp with time zone, "p_status" "text", "p_service_data" "jsonb", "p_require_deposit" boolean, "p_paid_deposit" boolean, "p_deposit_charge_id" "text", "p_reschedules" integer, "p_deposit_price" numeric, "p_selected_addons" "jsonb", "p_amount_due" numeric, "p_subtraction" boolean) TO "service_role";



GRANT ALL ON FUNCTION "public"."confirm_booking_session"("p_booking_session_id" "text", "p_user_id" "uuid", "p_business" "uuid", "p_client_metadata" "jsonb", "p_service_id" "uuid", "p_start" timestamp with time zone, "p_end" timestamp with time zone, "p_status" "text", "p_service_data" "jsonb", "p_require_deposit" boolean, "p_paid_deposit" boolean, "p_deposit_charge_id" "text", "p_reschedules" integer, "p_deposit_price" numeric, "p_selected_addons" "jsonb", "p_amount_due" numeric, "p_subtraction" numeric) TO "anon";
GRANT ALL ON FUNCTION "public"."confirm_booking_session"("p_booking_session_id" "text", "p_user_id" "uuid", "p_business" "uuid", "p_client_metadata" "jsonb", "p_service_id" "uuid", "p_start" timestamp with time zone, "p_end" timestamp with time zone, "p_status" "text", "p_service_data" "jsonb", "p_require_deposit" boolean, "p_paid_deposit" boolean, "p_deposit_charge_id" "text", "p_reschedules" integer, "p_deposit_price" numeric, "p_selected_addons" "jsonb", "p_amount_due" numeric, "p_subtraction" numeric) TO "authenticated";
GRANT ALL ON FUNCTION "public"."confirm_booking_session"("p_booking_session_id" "text", "p_user_id" "uuid", "p_business" "uuid", "p_client_metadata" "jsonb", "p_service_id" "uuid", "p_start" timestamp with time zone, "p_end" timestamp with time zone, "p_status" "text", "p_service_data" "jsonb", "p_require_deposit" boolean, "p_paid_deposit" boolean, "p_deposit_charge_id" "text", "p_reschedules" integer, "p_deposit_price" numeric, "p_selected_addons" "jsonb", "p_amount_due" numeric, "p_subtraction" numeric) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."dashboard_bookings_this_month"("business" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."dashboard_bookings_this_month"("business" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."dashboard_bookings_this_month"("business" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."dashboard_new_clients_this_month"("business" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."dashboard_new_clients_this_month"("business" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."dashboard_new_clients_this_month"("business" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."dashboard_returning_rate"("business" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."dashboard_returning_rate"("business" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."dashboard_returning_rate"("business" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."dashboard_revenue_this_month"("business" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."dashboard_revenue_this_month"("business" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."dashboard_revenue_this_month"("business" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_dashboard_growth"("p_stylist_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_dashboard_growth"("p_stylist_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_dashboard_growth"("p_stylist_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."search_stylists_nearby"("user_lat" double precision, "user_lon" double precision, "radius_km" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."search_stylists_nearby"("user_lat" double precision, "user_lon" double precision, "radius_km" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_stylists_nearby"("user_lat" double precision, "user_lon" double precision, "radius_km" double precision) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_location"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_location"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_location"() TO "service_role";
...
GRANT ALL ON TABLE "public"."banned_clients" TO "anon";
GRANT ALL ON TABLE "public"."banned_clients" TO "authenticated";
GRANT ALL ON TABLE "public"."banned_clients" TO "service_role";
...
GRANT ALL ON TABLE "public"."business_clients" TO "anon";
GRANT ALL ON TABLE "public"."business_clients" TO "authenticated";
GRANT ALL ON TABLE "public"."business_clients" TO "service_role";



GRANT ALL ON SEQUENCE "public"."business_clients_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."business_clients_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."business_clients_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."business_policies" TO "anon";
GRANT ALL ON TABLE "public"."business_policies" TO "authenticated";
GRANT ALL ON TABLE "public"."business_policies" TO "service_role";
...
GRANT ALL ON TABLE "public"."image_section" TO "anon";
GRANT ALL ON TABLE "public"."image_section" TO "authenticated";
GRANT ALL ON TABLE "public"."image_section" TO "service_role";



GRANT ALL ON TABLE "public"."marketplace_profile" TO "anon";
GRANT ALL ON TABLE "public"."marketplace_profile" TO "authenticated";
GRANT ALL ON TABLE "public"."marketplace_profile" TO "service_role";
...
GRANT ALL ON TABLE "public"."web_editors" TO "anon";
GRANT ALL ON TABLE "public"."web_editors" TO "authenticated";
GRANT ALL ON TABLE "public"."web_editors" TO "service_role";
