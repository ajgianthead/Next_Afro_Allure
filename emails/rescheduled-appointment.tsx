...
export default function RescheduledAppointment({ serviceName, clientData, businessData, appointmentData }: EmailTemplate) {
    ...
    return (
        <Html lang="en">
            <Head />
            <Preview>{`${clientData.firstName} ${clientData.lastName} rescheduled their ${serviceName} appointment to ${date}.`}</Preview>
                    ...
                    <Section style={{ backgroundColor: '#FFFFFF', borderRadius: '0 0 16px 16px' }}>
                        <Row>
                            <Column style={{ padding: '40px' }}>
                                ...
                                >
                                    {clientData.firstName} {clientData.lastName} rescheduled their appointment. Here are the updated details.
                                </Text>
