...
export default function AppointmentRescheduled({ serviceName, clientData, businessData, appointmentData }: EmailTemplate) {
    ...
    return (
        <Html lang="en">
            <Head />
            <Preview>{`Your appointment with ${businessData.name} has been rescheduled — ${date} at ${time}.`}</Preview>
                    ...
                    <Section style={{ backgroundColor: '#FFFFFF', borderRadius: '0 0 16px 16px' }}>
                        <Row>
                            <Column style={{ padding: '40px' }}>
                                ...
                                >
                                    Hi {clientData.firstName}, your appointment with {businessData.name} has been updated. Here are your new details.
                                </Text>
