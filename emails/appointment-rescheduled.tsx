...
export default function AppointmentRescheduled({ socials, serviceName, clientData, businessData, appointmentData }: EmailTemplate) {
    return (
        <Tailwind config={{
            theme: {
                extend: {
            ...
            <Html className="px-5 font-sans">
                ...
                <Container className="font-sans w-full text-center">
                    <Heading as="h2">Appointment Rescheduled! ✅</Heading>
                    <Text>{`Your appointment with ${businessData.name} has been successfully rescheduled. Here are the updated details:`}</Text>
                </Container>
                <Hr />
...
AppointmentRescheduled.PreviewProps = {
    socials: {
