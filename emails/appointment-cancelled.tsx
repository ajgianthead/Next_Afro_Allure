        ...
        <Tailwind config={{
            ...
            <Html className="px-5 font-sans">
                ...
                <Container className="font-sans w-full text-center">
                    <Heading as="h2">Appointment Canceled ❌</Heading>
                    <Text>{`Your appointment with ${businessData.name} for the following service(s) has been successfully canceled:`}</Text>
                </Container>
                <Hr />
                ...
                <Container className="font-sans mt-5">
                    <Text>{`If you have any questions, contact ${businessData.name}`}</Text>
                </Container>
