...
export default function CancelledAppointment({ serviceName, clientData, businessData, appointmentData }: EmailTemplate) {
    ...
    return (
        <Html lang="en">
            <Head />
            <Preview>{`${clientData.firstName} ${clientData.lastName} cancelled their ${serviceName} appointment.`}</Preview>
                    ...
                    <Section style={{ backgroundColor: '#FFFFFF', borderRadius: '0 0 16px 16px' }}>
                        <Row>
                            <Column style={{ padding: '40px' }}>
                                ...
                                >
                                    {clientData.firstName} {clientData.lastName} just cancelled their appointment scheduled for {date} at {time}.
                                </Text>
