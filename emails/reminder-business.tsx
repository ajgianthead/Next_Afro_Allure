...
export default function ReminderBusiness({ socials, serviceName, clientData, businessData, appointmentData }: EmailTemplate) {
    return (
        <Tailwind config={{
            theme: {
                extend: {
            ...
            <Html className="px-5 font-sans">
                ...
                <Container className="font-sans w-full text-center">
                    <Heading as="h2">‼️Appointment Reminder‼️</Heading>
