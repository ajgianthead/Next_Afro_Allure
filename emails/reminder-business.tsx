...
export default function ReminderBusiness({ serviceName, clientData, appointmentData }: EmailTemplate) {
    ...
    return (
        <Html lang="en">
            <Head />
            <Preview>{`Reminder: ${clientData.firstName} ${clientData.lastName} — ${serviceName} on ${date} at ${time}.`}</Preview>
                    ...
                    <Section style={{ backgroundColor: '#FFFFFF', borderRadius: '0 0 16px 16px' }}>
                        <Row>
                            <Column style={{ padding: '40px' }}>
                                ...
                                >
                                    You have an upcoming appointment with {clientData.firstName} {clientData.lastName}.
                                </Text>
