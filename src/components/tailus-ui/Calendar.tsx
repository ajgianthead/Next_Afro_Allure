...
// Custom navigation component to use custom icons
const CustomNav = ({ onPreviousClick, onNextClick, className }: NavProps) => (
...
export const Calendar = ({
    ...
    return (
        <DayPicker
            ...
            components={{
                Nav: CustomNav,  // Use the custom navigation component
            }}
            {...props}
        />
    )
